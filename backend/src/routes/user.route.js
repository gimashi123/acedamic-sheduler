...
import { registerAdmin, registerUser, getUsers, getUsersByRole, removeUser, getRemovedUsers, updateUser } from '../controller/user.controller.js';
...
router.get('/removed', authenticateToken, authorizeRole([ROLES.ADMIN]), getRemovedUsers);
...
router.put('/:userId', authenticateToken, authorizeRole([ROLES.ADMIN]), updateUser);
